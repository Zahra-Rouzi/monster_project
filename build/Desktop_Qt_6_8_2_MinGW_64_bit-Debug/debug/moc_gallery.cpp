...
static constexpr auto qt_meta_stringdata_ZN7GalleryE = QtMocHelpers::stringData(
    "Gallery",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7GalleryE[] = {
...
Q_CONSTINIT const QMetaObject Gallery::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7GalleryE.offsetsAndSizes,
    qt_meta_data_ZN7GalleryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7GalleryE_t,
        // Q_OBJECT / Q_GADGET
...
void *Gallery::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7GalleryE.stringdata0))
